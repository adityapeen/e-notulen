    ...
    <div class="col-12">
      <div class="card my-4">
        ...
        <div class="card-body pb-2">
          ...
          <form action={{ route('admin.notes.update', $note->hashed_id )}} method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-8">
                <select id="agendas" multiple="multiple" class="form-select border px-1 @error('agendas') is-invalid @enderror" value="" name="agendas[]">
