              ...
              <tbody>
                @foreach ($undone as $item)
                  <tr>
                    ...
                    <td style="cursor: pointer" class="clickable-action" data-id="{{ $item->hashed_id}}">
                      <?= $item->note->name ?>
                    ...
                    <td class="align-middle">                                        
                      <a href="{{ route('user.notes.evidence', $item->hashed_id)}}" class="badge btn-success badge-sm bg-gradient-success" >Eviden</a>                  
                    </td>
                  </tr>
                @endforeach
                @if(sizeof($undone) == 0)
            ...
            <table class="align-items-center mb-0 table">
              <tbody>
                @foreach ($todays as $item)
                  <tr class="clickable-row" data-href="{{ $item->status != "lock" ? "#" : route('user.notes.show', $item->hashed_id) }}">
