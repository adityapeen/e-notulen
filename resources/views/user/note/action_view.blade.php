      ...
      <div class="card-body">
        ...
        <div class="action-items">
              ...
              <div class="input-group baru-data mb-1">
                ...
                <div class="col me-1">
                  <a href="{{ route('user.notes.evidence', [$item->hashed_id] ) }}" class="btn btn-info btn-sm" title="Evidences"><i class="fa fa-tasks"></i><span class="badge text-bg-light ms-2">{{ $item->evidences_count }}</span></a>
                </div>
              </div>
