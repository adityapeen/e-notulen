    ...
    <div class="col-12">
      <div class="card my-4">
        ...
        <div class="card-body pb-2">
          ...
          <form action={{ route('satker.evidences.store')}} method="POST" enctype="multipart/form-data">
            @csrf
            @method('post')
            ...
            <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-8">
                <input type="text" id="description" class="form-control border px-1 @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" placeholder="Deskripsi File" required>
              </div>
            </div>         
            <div class="row mb-1 align-items-center">
              <div class="col-md-4">
