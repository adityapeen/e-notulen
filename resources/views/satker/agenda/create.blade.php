    ...
    <div class="col-12">
      <div class="card my-4">
        ...
        <div class="card-body pb-2">
          ...
          <form action={{ route('satker.agendas.store')}} method="POST">
            @csrf
            @method('post')
            ...
            <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-8">
                <input type="text" id="docs_template_id" class="form-control border px-1 @error('docs_template_id') is-invalid @enderror" name="docs_template_id" value="{{ old('docs_template_id') }}" placeholder="isikan ID template notulen">
              </div>
            </div>
            <div class="row mb-1 align-items-center">
              <div class="col-md-4">
