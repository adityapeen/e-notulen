              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle text-sm">
                    ...
                    <a href="{{ route('ses.notes.evidence', $item->hashed_id)}}" class="btn btn-sm bg-gradient-info mb-0">Evidences
                  ...
                  <td class="align-middle text-sm">
                    ...
                    <a href="{{ route('ses.notes.show', $item->note->hashed_id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" title="Lihat Notulensi">
